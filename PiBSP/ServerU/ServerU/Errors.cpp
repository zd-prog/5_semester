...
string GetErrorMsgText(int code)
{
	...
	case WSA_OPERATION_ABORTED: msgText = "Операция отвергнута";
		break;
	/*case WSAINVALIDPROCTABLE: msgText = "Ошибочный сервис";
		break;
	case WSAINVALIDPROVIDER: msgText = "Ошибка в версии сервиса";
		break;
	case WSAPROVIDERFAILEDINIT: msgText = "Невозможно инициализировать сервис";
		break;*/
	case WSASYSCALLFAILURE: msgText = "Аварийное завершение системного вызова";
		break;
	default: msgText = "Ошибка обработки";
		break;
	}
	return msgText;
}
