...
public class GroupProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "by.ziziko.providers.GroupsList";
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        switch (uriMatcher.match(uri)) {
            ...
            case URI_GROUPS_ID: // Uri с ID
                ...
                if (TextUtils.isEmpty(selection)) {
                    selection = "IDGROUP" + " = " + id;
                } else {
                    selection = selection + " AND " + "IDGROUP" + " = " + id;
                }
                break;
            default:
        ...
        Cursor cursor = db.query("GROUPS", projection, selection,
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        db = dbHelper.getWritableDatabase();
        long rowID = db.insert("GROUPS", null, contentValues);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        db = dbHelper.getWritableDatabase();
        int cnt = db.delete("GROUPS", selection, selectionArgs);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        db = dbHelper.getWritableDatabase();
        int cnt = db.update("GROUPS", contentValues, selection, selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);
        return cnt;    }
}
